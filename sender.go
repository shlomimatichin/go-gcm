...
const (
	// GcmSendEndpointReal is the endpoint for sending messages to the GCM server.
	GcmSendEndpointReal = "https://gcm-http.googleapis.com/gcm/send"
...
var GcmSendEndpoint = GcmSendEndpointReal
